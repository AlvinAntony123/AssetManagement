        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingAbbrv = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityAbbrv = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FacilityId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FaciltyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FaciltyFloor = table.Column<short>(type: "smallint", nullable: false),
                    CityId = table.Column<int>(type: "int", nullable: false),
                    BuildingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_BuildingAbbrv",
                table: "Buildings",
                column: "BuildingAbbrv",
                unique: true,
                filter: "[BuildingAbbrv] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_CityAbbrv",
                table: "Cities",
                column: "CityAbbrv",
                unique: true,
                filter: "[CityAbbrv] IS NOT NULL");
